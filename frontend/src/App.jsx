  ...
  return (
    <Layout>
      <Routes>
        ...
        <Route path="/reports"        element={user?.role === 'secretary' ? <Navigate to="/" /> : <Reports />} />
        <Route path="/expenses"       element={<Expenses />} />
        <Route path="/debts"          element={<Debts />} />
        <Route path="/prescriptions"  element={<Prescriptions />} />
        <Route path="/drugs"          element={user?.role === 'secretary' ? <Navigate to="/" /> : <DrugStore />} />
        <Route path="/settings"       element={<Settings />} />
        <Route path="/inventory"      element={<Inventory />} />
        <Route path="/daily-summary"  element={user?.role === 'secretary' ? <Navigate to="/" /> : <DailySummary />} />
        <Route path="/audit-log"      element={user?.role === 'secretary' ? <Navigate to="/" /> : <AuditLog />} />
